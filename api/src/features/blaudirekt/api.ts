const api = 'https://mitarbeiterwebservice.maklerinfo.biz/service';
const grant = {
  version: 'v1',
  id: '8fcc2bf4-98f0-4b6e-bb73-c25252a1b000',
  issuer:
    'https\/\/auth.dionera.dev\/clients\/fcece489-e5d1-4cf5-9654-35c8d5dec758',
  token_endpoint: 'https:\/\/auth.dionera.com\/oauth2\/token',
  audience: 'https:\/\/auth.dionera.com\/oauth2\/token',
  grant_type: 'urn:ietf:params:oauth:grant-type:jwt-bearer',
  sub: '00GKFG_RZB6QA',
  scope: ['ameise.stocks', 'ameise\/mitarbeiterwebservice'],
  jwk: {
  ...
  client_secret:
    'yF2yIwb3doTauiyBFnLcMBhtIs-dTQ5I5KveECituMZ6PXgz9rioho1Tb11rf_mugbQp9TJs',
